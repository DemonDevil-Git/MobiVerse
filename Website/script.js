...
const translations = {
  zh: {
    ...
    "nav.privacy": "隐私",
    "nav.download": "下载最新版",
    "hero.eyebrow": "MobiVerse 2.4.1 · 本地优先的阅读转换工具",
    ...
    "latest.eyebrow": "最新版本 · 2026 年 8 月 11 日",
    "latest.title": "MobiVerse 2.4.1<br><em>首次打开，更稳更可靠。</em>",
    "latest.lead": "本次 macOS 补丁修复新用户首次启动闪退，并整理 Browse 标签栏和中文工作区布局。",
    "latest.notes": "查看完整发布说明",
    "latest.languageTitle": "首次启动闪退已修复",
    "latest.languageBody": "本地化资源会从安装包的真实位置安全加载，新用户第一次打开不再因资源定位失败而退出。",
    "latest.shelfTitle": "中文工作区重新居中",
    "latest.shelfBody": "“书架 / 浏览”分段选择器占满可用宽度，中文短标签不再让整个控件明显偏左。",
    "latest.downloadTitle": "+ 固定在下载左侧",
    "latest.downloadBody": "Browse 的新增标签按钮保持在右侧操作区，并紧邻下载按钮左边。",
    "latest.detailLabel": "同时改进",
    "latest.detailBody": "最终 DMG 会从挂载卷以全新偏好目录启动，并在稳定窗口持续运行；51 项自动化测试已全部通过。",
  ...
  en: {
    ...
    "hero.eyebrow": "MobiVerse 2.4.1 · Local-first reading and conversion",
    ...
    "latest.eyebrow": "Latest release · August 11, 2026",
    "latest.title": "MobiVerse 2.4.1<br><em>A safer, steadier first launch.</em>",
    "latest.lead": "This macOS patch fixes a first-launch crash for new users and tidies the Browse toolbar and Chinese workspace layout.",
    "latest.notes": "Read the full release notes",
    "latest.languageTitle": "First-launch crash fixed",
    "latest.languageBody": "Packaged localization now resolves from its real installed location, preventing a new user's first launch from exiting during startup.",
    "latest.shelfTitle": "Chinese workspace centered",
    "latest.shelfBody": "The Shelf/Browse segmented control fills its available width, so shorter Chinese labels no longer pull the control left.",
    "latest.downloadTitle": "+ stays left of Downloads",
    "latest.downloadBody": "Browse keeps the new-tab button in the trailing action area immediately to the left of Downloads.",
    "latest.detailLabel": "Also improved",
    "latest.detailBody": "The final mounted DMG now launches with fresh preferences and must survive a stability window; all 51 automated tests pass.",
