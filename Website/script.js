...
const translations = {
  zh: {
    ...
    "nav.privacy": "隐私",
    "nav.download": "下载最新版",
    "hero.eyebrow": "MobiVerse 2.5.0 · 本地优先的阅读转换工具",
    ...
    "latest.eyebrow": "最新版本 · 2026 年 8 月 24 日",
    "latest.title": "MobiVerse 2.5.0<br><em>让界面退后，让故事靠前。</em>",
    "latest.lead": "全新的沉浸式阅读体验、更丝滑可管理的下载列表，以及更接近真实安装场景的首次启动验证。",
    "latest.notes": "查看完整发布说明",
    "latest.languageTitle": "沉浸式阅读器",
    "latest.languageBody": "控件与鼠标指针自动隐藏，支持全屏、键盘翻页、自适应画布和相邻页面预加载。",
    "latest.shelfTitle": "三种漫画阅读方式",
    "latest.shelfBody": "单页、双页跨页与纵向连续模式均支持从左到右或从右到左的书籍方向。",
    "latest.downloadTitle": "下载记录可管理",
    "latest.downloadBody": "下载页改为顺滑纵向列表，可逐条删除记录，同时保留已下载的书籍文件。",
    "latest.detailLabel": "同时改进",
    "latest.detailBody": "最终 DMG 会复制到全新 Applications 模拟目录、卸载镜像、验证签名并冷启动；macOS 51 项与 Windows 核心 55 项测试全部通过。",
    ...
    "demo.eyebrow": "51 秒产品演示",
    "demo.title": "从立体书架，<br>走进内置浏览空间。",
    "demo.lead": "观看 MobiVerse 的交互式 3D 书架、工作区切换、标签浏览和下载流程。无需离开应用，也不必把本地图书交给云端。",
    "demo.videoLabel": "MobiVerse 产品演示视频",
    "demo.fallback": "下载 MobiVerse 演示视频",
    "demo.caption": "真实产品操作 · 51 秒 · 无配音",
    "demo.github": "在 GitHub 获取演示视频",
    ...
    "features.readerTitle": "沉浸式内置阅读器",
    "features.readerBody": "文字书水平翻页；漫画支持单页、双页与连续滚动。主题、字号、方向和阅读位置都被记住。",
  ...
  en: {
    ...
    "hero.eyebrow": "MobiVerse 2.5.0 · Local-first reading and conversion",
    ...
    "latest.eyebrow": "Latest release · August 24, 2026",
    "latest.title": "MobiVerse 2.5.0<br><em>Let the interface recede and the story take over.</em>",
    "latest.lead": "A new immersive reader, a smoother and manageable download list, and first-launch checks that mirror a real clean installation.",
    "latest.notes": "Read the full release notes",
    "latest.languageTitle": "Immersive reader",
    "latest.languageBody": "Controls and the cursor auto-hide, with full screen, keyboard navigation, adaptive canvas color, and adjacent-page preloading.",
    "latest.shelfTitle": "Three comic reading modes",
    "latest.shelfBody": "Single page, two-page spread, and continuous scroll all respect left-to-right and right-to-left book direction.",
    "latest.downloadTitle": "Manage download records",
    "latest.downloadBody": "Downloads now use a smooth vertical list, and each record can be removed without deleting a completed book file.",
    "latest.detailLabel": "Also improved",
    "latest.detailBody": "The final DMG is copied into a clean Applications-like directory, detached, signature-checked, and cold-launched; 51 macOS and 55 Windows core tests pass.",
    ...
    "demo.eyebrow": "51-second product demo",
    "demo.title": "From the dimensional shelf<br>into the built-in browser.",
    "demo.lead": "See MobiVerse's interactive 3D shelf, workspace switching, tabbed browsing, and download flow—without leaving the app or sending local books to the cloud.",
    "demo.videoLabel": "MobiVerse product demo video",
    "demo.fallback": "Download the MobiVerse demo video",
    "demo.caption": "Real product workflow · 51 seconds · No narration",
    "demo.github": "Get the demo video on GitHub",
    ...
    "features.readerTitle": "An immersive built-in reader",
    "features.readerBody": "Turn text books horizontally and read comics as single pages, spreads, or a continuous strip. Theme, type, direction, and position are remembered.",
