...
const translations = {
  zh: {
    ...
    "nav.privacy": "隐私",
    "nav.download": "下载最新版",
    "hero.eyebrow": "MobiVerse 2.4.0 · 本地优先的阅读转换工具",
    ...
    "latest.eyebrow": "最新版本 · 2026 年 8 月 4 日",
    "latest.title": "MobiVerse 2.4.0<br><em>让书架、下载和中文体验更自然。</em>",
    "latest.lead": "本次 macOS 更新聚焦完整简体中文界面、响应迅速的 3D 书架，以及更可靠的 Browse 下载体验。",
    "latest.notes": "查看完整发布说明",
    "latest.languageTitle": "完整中文界面",
    "latest.languageBody": "新增简体中文翻译和应用内语言选择器，可在简体中文、English 与跟随系统之间切换。",
    "latest.shelfTitle": "更快、更顺滑的 3D 书架",
    "latest.shelfBody": "随机点击可见书籍也能保持弹簧过渡；悬停与命中更稳定，转换中、验证中和最新完成的书会自动排到最前面。",
    "latest.downloadTitle": "下载状态一眼可见",
    "latest.downloadBody": "Browse 右上角会在下载时显示动态状态；取消操作现在会立即停止任务并从下载列表移除。",
    "latest.detailLabel": "同时改进",
    "latest.detailBody": "大型 EPUB 的封面和元数据读取更高效；3D 封面底部不再显示多余绿边；51 项自动化测试已全部通过。",
  ...
  en: {
    ...
    "hero.eyebrow": "MobiVerse 2.4.0 · Local-first reading and conversion",
    ...
    "latest.eyebrow": "Latest release · August 4, 2026",
    "latest.title": "MobiVerse 2.4.0<br><em>A more natural shelf, download flow, and Chinese experience.</em>",
    "latest.lead": "This macOS update focuses on complete Simplified Chinese support, a responsive 3D shelf, and more reliable downloads in Browse.",
    "latest.notes": "Read the full release notes",
    "latest.languageTitle": "A complete Chinese interface",
    "latest.languageBody": "Use the new in-app language selector to choose Simplified Chinese, English, or follow the macOS system language.",
    "latest.shelfTitle": "A faster, smoother 3D shelf",
    "latest.shelfBody": "Direct and random book selection keeps its spring transition, hover and hit testing stay stable, and converting, validating, and newest books move to the front.",
    "latest.downloadTitle": "Download activity at a glance",
    "latest.downloadBody": "Browse now animates its Downloads indicator while a file is active, and Cancel immediately stops and removes the download.",
    "latest.detailLabel": "Also improved",
    "latest.detailBody": "Large EPUB covers and metadata load more efficiently, the redundant green strip is gone from 3D covers, and all 51 automated tests pass.",
