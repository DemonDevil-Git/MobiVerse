...
struct ComicEpubPostProcessorTests {
    ...
    func postProcessorRewritesComicLayoutMetadataAndTOC() async throws {
        ...
        #expect(updatedOPF.contains(#"id="page-00001" href="pages/page-00001.xhtml" media-type="application/xhtml+xml" properties="svg""#))
        ...
        #expect(updatedOPF.components(separatedBy: #"property="dcterms:modified""#).count - 1 == 1)
